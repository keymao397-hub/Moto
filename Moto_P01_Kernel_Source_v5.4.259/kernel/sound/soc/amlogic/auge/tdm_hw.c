	...
	if (stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		if (use_vadtop) {
			...
			case TDM_D:
				...
				break;
			case TDM_LB:
				reg = EE_AUDIO_TDMIN_LB_CTRL;
				break;
			case TDMB_LB:
				reg = EE_AUDIO_TDMINB_LB_CTRL;
				break;
			default:
				reg = EE_AUDIO_TDMIN_LB_CTRL;
				pr_err("%s:error tdmin index!\n", __func__);
				break;
			}
		...
		bool use_vadtop)
{
	...
	if (use_vadtop) {
		...
		case TDM_D:
			...
			break;
		case TDM_LB:
			reg = EE_AUDIO_CLK_TDMIN_LB_CTRL;
			break;
		case TDMB_LB:
			reg = EE_AUDIO_CLK_TDMINB_LB_CTRL;
			break;
		default:
			reg = EE_AUDIO_CLK_TDMIN_LB_CTRL;
			pr_err("%s:error tdmin index!\n", __func__);
	...
	if (capture_active) {
		...
		if (use_vadtop) {
			...
			case TDM_D:
				...
				break;
			case TDM_LB:
				reg_in = EE_AUDIO_CLK_TDMIN_LB_CTRL;
				break;
			case TDMB_LB:
				reg_in = EE_AUDIO_CLK_TDMINB_LB_CTRL;
				break;
			default:
				reg_in = EE_AUDIO_CLK_TDMIN_LB_CTRL;
				pr_err("%s:error tdmin index!\n", __func__);
			...
			case TDM_D:
				...
				break;
			case TDM_LB:
				reg_in = EE_AUDIO_TDMIN_LB_CTRL;
				break;
			case TDMB_LB:
				reg_in = EE_AUDIO_TDMINB_LB_CTRL;
				break;
			default:
				reg_in = EE_AUDIO_TDMIN_LB_CTRL;
				pr_err("%s:error tdmin index!\n", __func__);
		...
		if (use_vadtop) {
			...
			if (lane >= LANE_MAX1) {
				...
				case TDM_D:
					...
					break;
				case TDM_LB:
					reg = EE_AUDIO_TDMIN_LB_MASK4;
					break;
				case TDMB_LB:
					reg = EE_AUDIO_TDMINB_LB_MASK4;
					break;
				default:
					pr_err("%s:error tdmin index!\n", __func__);
					break;
				...
				case TDM_D:
					...
					break;
				case TDM_LB:
					reg = EE_AUDIO_TDMIN_LB_MASK0;
					break;
				case TDMB_LB:
					reg = EE_AUDIO_TDMINB_LB_MASK0;
					break;
				default:
					reg = EE_AUDIO_TDMIN_LB_MASK0;
					pr_err("%s:error tdmin index!\n", __func__);
	...
	if (stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		if (use_vadtop) {
			...
			case TDM_D:
				...
				break;
			case TDM_LB:
				reg = EE_AUDIO_TDMIN_LB_SWAP0;
				break;
			case TDMB_LB:
				reg = EE_AUDIO_TDMINB_LB_SWAP0;
				break;
			default:
				reg = EE_AUDIO_TDMIN_LB_SWAP0;
				pr_err("%s:error tdmin index!\n", __func__);
			...
			if (swap1) {
				...
				case TDM_D:
					...
					break;
				case TDM_LB:
					reg = EE_AUDIO_TDMIN_LB_SWAP1;
					break;
				case TDMB_LB:
					reg = EE_AUDIO_TDMINB_LB_SWAP1;
					break;
				default:
					reg = EE_AUDIO_TDMIN_LB_SWAP1;
					pr_err("%s:error tdmin index!\n", __func__);
		...
		int tdm_index, bool mute, int lane_cnt, bool use_vadtop)
{
	...
	if (use_vadtop) {
		...
		case TDM_D:
			...
			break;
		case TDM_LB:
			reg = EE_AUDIO_TDMIN_LB_MUTE0;
			break;
		case TDMB_LB:
			reg = EE_AUDIO_TDMINB_LB_MUTE0;
			break;
		default:
			reg = EE_AUDIO_TDMIN_LB_MUTE0;
			pr_err("%s:error tdmin index!\n", __func__);
	...
	if (lane_cnt > LANE_MAX1) {
		if (use_vadtop) {
			...
			case TDM_D:
				...
				break;
			case TDM_LB:
				reg = EE_AUDIO_TDMIN_LB_MUTE4;
				break;
			case TDMB_LB:
				reg = EE_AUDIO_TDMINB_LB_MUTE4;
				break;
			default:
				reg = EE_AUDIO_TDMIN_LB_MUTE4;
				pr_err("%s:error tdmin index!\n", __func__);
...
int aml_tdmin_get_status(int tdm_id, bool use_vadtop)
{
	...
	if (use_vadtop) {
		...
		case TDM_D:
			...
			break;
		case TDM_LB:
			reg = EE_AUDIO_TDMIN_LB_STAT;
			break;
		case TDMB_LB:
			reg = EE_AUDIO_TDMINB_LB_STAT;
			break;
		default:
			reg = EE_AUDIO_TDMIN_LB_STAT;
			pr_err("%s:error tdmin index!\n", __func__);
